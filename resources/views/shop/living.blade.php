...
<section style="padding:80px 0; background:#faf7f5;">
    ...
    ">
        ...
        ">
            <img src="/images/living1.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/living2.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    'id' => 18,
    'name' => 'Feeding Bowl Set',
    'price' => 35.00,
    'image' => '/images/living2.png'
]) }}">
    Add to Cart
</a>
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/living3.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/living4.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/living5.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/living6.png" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/li7.jpg" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
...
<a href="{{ route('cart.add', [
    ...
    Add to Cart
        ...
        <div style="
            ...
            box-shadow:0 10px 30px rgba(0,0,0,0.06);
        ">
            <img src="/images/li8.jpg" style="width:100%; height:260px; object-fit:cover; border-radius:16px;">
